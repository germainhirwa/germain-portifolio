...
const projects = [
  {
    ...
    github: "https://github.com/your-username/link-saver",
  },
  {
    num: "02",
    category: "Machine Learning Game",
    title: "Rock-Paper-Scissors with AI",
    description: "A fun game of Rock-Paper-Scissors that uses hand detection via a webcam and machine learning to predict and play against the user.",
    stack: [{ name: "Python" }, { name: "OpenCV" }, { name: "MediaPipe" }],
    image: "/assets/rock_paper_scissors.png",
    live: "",
    github: "https://github.com/your-username/rock-paper-scissors-ai",
  },
  {
    num: "03",
...
//// I don't know why it is not doing what I want it to do 
...
//       <button className={`swiper-button-prev ${btnStyles}`}></button>
//       <button className={`swiper-button-next ${btnStyles}`}></button>
//     </div>
//   );
// };
...
//     description: "App enabling Rwandan users to learn traffic rules in preparation for driving tests. The app was later commercially acquired by the Rwandan National Police.",
//     stack: [{ name: "Flutter" }, { name: "Dart" }],
//     image: "/assets/traffic_rules.png",
//     live: "https://play.google.com/store/apps/details?id=com.traffic.rules&pcampaignid=web_share&pli=1",
//     github: "https://github.com/your-username/traffic-rules-app",
//   },
//   {
...
//   if (!project) return null; // Add this line to handle the case where project is null
...
//                         <VideoPlayer src={getGoogleDriveDirectLink(project.video)} />
//                       ) : (
//                         <Image
//                           src={project.image}
//                           fill
